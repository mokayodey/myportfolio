...
export default function CashLoanUX() {
  return (
      <div className="min-h-screen w-full bg-canvas text-ink">
        ...
        <CaseHero
          eyebrow="Product Design Lead · 2026"
        ...
        <Section label="Four flows, one question">
        ...
        <Section label="The affordability-first idea" bg="muted">
          <div className="mb-12 flex flex-col gap-10 md:flex-row md:gap-16">
            <div className="max-w-[720px] flex-1">
              <p className="mb-5 text-base font-normal leading-relaxed text-ink/82 md:text-lg">
                Every amount-first variant asked the same opening question —{" "}
                <em>how much do you want to borrow?</em> — and left customers
                to work out whether the repayment was affordable. But across
                both markets, the number people actually reasoned from
                wasn&apos;t the loan size. It was the daily payment:{" "}
                <em>
              ...
              <p className="text-base font-normal leading-relaxed text-ink/82 md:text-lg">
                ...
                ways — a single live screen that filters offers as you set a
                daily figure, and a guided step-by-step version that walks
                first-time borrowers through budget, then amount, then
                confirmation.
              </p>
            </div>
            <div className="flex flex-none flex-col gap-5 md:w-[280px]">
              <div className="border-t border-ink/20 pt-4">
                ...
                <div className="text-sm font-medium leading-relaxed text-ink/70">
                  the figure customers named again and again as the one they
                  decide on
                </div>
              </div>
              <div className="border-t border-ink/20 pt-4">
        ...
        <Section label="Test the flows yourself">
          <p className="mb-7 max-w-[720px] text-base font-normal leading-relaxed text-ink/82 md:text-lg">
            ...
            then tap the <b className="font-bold">M-KOPA</b> app icon on the
            phone&apos;s home screen to launch it — just as participants did
            in testing. The <b className="font-bold">All flows</b> icon
            returns you here to try another.
          </p>
          <iframe
        ...
        <Section label="What won, market by market">
          <p className="mb-8 max-w-[720px] text-base font-normal leading-relaxed text-ink/82 md:text-lg">
            The strongest option differed by market — but the two-knob
            variant lost everywhere, badly enough to rule out outright.
          </p>
          <div className="mb-8 grid grid-cols-1 gap-6 sm:grid-cols-2">
            <div className="rounded-md bg-ink p-7 text-canvas">
              <div className="mb-3.5 text-[11px] font-semibold uppercase tracking-[.1em] text-gold">
                Kenya winner
              </div>
              <div className="mb-3.5 font-archivo-expanded text-2xl font-extrabold">
                Filter by amount
              </div>
              <div className="flex gap-7">
                <div>
                  <div className="font-archivo-expanded text-[22px] font-bold">
                    6.25
                  </div>
                  <div className="mt-1 text-xs font-medium leading-[1.4] text-canvas/60">
                    SEQ (above the 5.5 norm)
                  </div>
                </div>
                <div>
                  <div className="font-archivo-expanded text-[22px] font-bold">
        ...
        <Section label="Key findings" bg="muted">
        ...
        <Section label="Recommendations & decision">
          ...
          <div className="mt-8 max-w-[760px] rounded-md bg-ink p-6 text-canvas">
        ...
        <Section label="The end-to-end flow">
          <p className="mb-11 max-w-[760px] text-base font-normal leading-relaxed text-ink/82 md:text-lg">
            To keep the test a fair comparison, only the amount-selection
            step differed between variants — everything after it was
            identical. Once a customer had chosen their loan, all five flows
            funnelled into the same review-and-confirm screen and the same
            disbursement success screen. Holding these steps constant meant
            any difference in how well people understood their loan could be
            traced back to the one thing under test: how they picked the
            amount.
          </p>
          ...
          <div className="mb-10 flex flex-wrap items-center gap-7">
            ...
            <div className="min-w-[220px] flex-1 rounded-[10px] bg-ink px-7 py-6 text-canvas">
              ...
              <p className="mt-3.5 text-sm font-normal leading-[1.55] text-canvas/72">
                ...
                comprehension differences could only come from the selection
                step above.
              </p>
            </div>
          </div>
        ...
        <Section label="How this was built" bg="ink" inverted>
          <div className="flex flex-col gap-10 md:flex-row md:gap-16">
            <div className="max-w-[720px] flex-1">
              <h2 className="mb-6 max-w-[640px] font-archivo-expanded text-2xl font-extrabold leading-[1.2] tracking-[-.01em] md:text-[34px]">
                Five production-grade prototypes, built and shipped in the
                time a single Figma flow usually takes.
              </h2>
              <p className="mb-5 text-base font-normal leading-relaxed text-canvas/78 md:text-lg">
              ...
              <p className="mb-5 text-base font-normal leading-relaxed text-canvas/78 md:text-lg">
                ...
                surfaced because the prototype responded like the real thing.
                A tap-through Figma mockup would have hidden it. We then
                deployed each build to{" "}
                <b className="font-bold text-canvas">Netlify</b> as an
                installable web app, so moderators ran the sessions on
                participants&apos; own phones, full-screen, indistinguishable
                from production.
              </p>
              <p className="text-base font-normal leading-relaxed text-canvas/78 md:text-lg">
            ...
            <div className="flex flex-none flex-col gap-7 md:w-[260px]">
              <div className="border-t border-canvas/22 pt-4">
                <div className="mb-1.5 font-archivo-expanded text-2xl font-extrabold text-gold md:text-[40px]">
                  5
                </div>
                <div className="text-sm font-medium leading-relaxed text-canvas/70">
        ...
        <Section label="What went live" bg="muted">
          <div className="mb-11 flex flex-col gap-10 md:flex-row md:gap-16">
            <div className="max-w-[720px] flex-1">
              <h2 className="mb-[22px] max-w-[640px] font-archivo-expanded text-2xl font-extrabold leading-[1.2] tracking-[-.01em] md:text-[34px]">
              ...
              <p className="mb-5 text-base font-normal leading-relaxed text-ink/82 md:text-lg">
                ...
                <b className="font-bold">Dropdown</b>. Both were refined into
                production builds and are now being rolled out as an A/B test
                against the current live experience —{" "}
                <b className="font-bold">Flow 1 (Today)</b> — so the final
                call is made on real behaviour at scale, not just moderated
                sessions.
              </p>
              <p className="text-base font-normal leading-relaxed text-ink/82 md:text-lg">
                The two shipped screens are embedded below, exactly as they
                went out.
              </p>
            </div>
            <div className="flex flex-none flex-col gap-6 md:w-[280px]">
              <div className="border-t border-ink/20 pt-4">
                ...
                <div className="text-sm font-medium leading-relaxed text-ink/70">
                  both winners tested live against the current baseline (Flow
                  1)
                </div>
              </div>
              <div className="border-t border-ink/20 pt-4">
          ...
          <div className="max-w-[760px] border-l-[3px] border-accent py-1 pl-6">
            ...
            <p className="m-0 text-base font-normal leading-relaxed text-ink/80">
              ...
              section documents recent work and process rather than a final
              outcome. I&apos;ll update it with the winning variant and its
              metrics once the experiment concludes.
            </p>
          </div>
        </Section>
