      ...
      <div className="min-h-screen w-full bg-canvas text-ink">
        ...
        <SectionRow label="Research">
          ...
          <p className="text-base font-normal leading-relaxed text-ink/78 md:text-[17px]">
            ...
            or it would be rejected by whichever side lost.
          </p>
        </SectionRow>
        ...
        <Section label="Trade-offs I made deliberately">
        ...
        <Section label="Product architecture" bg="ink" inverted>
        ...
        {/* impact */}
        <div className="px-4 py-16 sm:px-5 md:px-14 md:py-24">
